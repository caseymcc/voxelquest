...
GamePageHolder* GameLogic::getHolderById(int blockId, int chunkId, int holderId) {
...
bool GameLogic::addGroupToStack(
...
void GameLogic::drawLineAtIndices(
...
void GameLogic::loadNearestHolders(bool doUpdate) { //int rad, 
