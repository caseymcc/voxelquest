...
int GamePageHolder::getCellAtInd(
    int ind
)
{
...
void GamePageHolder::getArrAtInd(
    int ind,
    int* tempCellData,
    int* tempCellData2
)
...
int GamePageHolder::floodFillAtInd(
    int firstInd,
    int newId,
    bool findCenter,
                                    ...
                                    )
                                {
                                    ...
                                    if(targetCost<=cNode->totCost)
                                    {
                                        ...
                                        if(targetCost==cNode->totCost)
                                        {
                                            ...
                                            if((k+kk)<(kc+kkc)) { foundBetter=true; }
                                            else
                                            {
                                                if((j+jj)<(jc+jjc)) { foundBetter=true; }
                                                else
                                                {
