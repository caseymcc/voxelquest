...
void Singleton::playSoundPosAndPitch(
    string soundName,
...
void Singleton::updateSoundPosAndPitch(
    string soundName,
    FIVector4* listenerPos,
    FIVector4* soundPos,
    float volume=1.0f,
...
void Singleton::playSound(string soundName, float volume=1.0f)
{
    prepSound(soundName);
    soundMap[soundName].play(volume);
}

void Singleton::playSoundEvent(const char* eventName, bool suppress=false)
{
...
void Singleton::sampleFBODirect(
    FBOSet *fbos,
...
void Singleton::unsampleFBODirect(
    FBOSet *fbos,
    int offset=0, /* write offset */
    int _minOff=0, /* read min */
    int _maxOff=-1 /* read max */
...
void Singleton::bindFBODirect(FBOSet *fbos, int doClear=1)
{
    setMatrices(fbos->width, fbos->height);
...
void Singleton::copyFBO(string src, string dest, int num=0)
{
...
void Singleton::copyFBO2(string src, string dest, int num1=0, int num2=1)
{
...
void Singleton::copyFBO3(string src, string dest, int num1=0, int num2=1, int num3=2)
{
...
void Singleton::bindFBO(string fboName, int swapFlag=-1, int doClear=1)
{
...
{
    Singleton::curShaderPtr->updateUniformBlock(ubIndex, ubDataSize);
}
void invalidateUniformBlock(int ubIndex)
{
    Singleton::curShaderPtr->invalidateUniformBlock(ubIndex);
}
void beginUniformBlock(int ubIndex)
{
    Singleton::curShaderPtr->beginUniformBlock(ubIndex);
}
...
float Singleton::getHeightAtPixelPos(float x, float y, bool dd=false)
{
    FBOWrapper *fbow;
    float xc;
    float yc;
...
void Singleton::toggleSetting(int settingName, bool withVoice=true)
{
...
void Singleton::setSetting(int settingName, bool value, bool withVoice=true)
{
...
bool Singleton::processJSONFromString(
    string* sourceBuffer,
    JSONValue** destObj
)
{
...
void Singleton::loadValuesGUI(bool applyValues=false)
{
...
std::ifstream::pos_type Singleton::filesize(const char* filename)
{
